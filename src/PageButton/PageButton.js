                ...
                <div className={styles.container__body}>
                    <div className={styles.container__context_func}>
                        ...
                        <button className={styles.button__calc}
                                onClick={() => setIsVisibility(isVisibility ? false : true)}
                        >Рассчитать</button>
                        <div className={styles.container__context_result} hidden={isVisibility}>
                            ...
                            <ul className={styles.unordered__list}>
                                <li className={styles.unordered__list_point}>
                                    ...
                                    <label htmlFor="point_first">78 000 рублей <span className={styles.unordered__list_point_year}>в 1-ый год</span></label>
                                </li>
                                <li className={styles.unordered__list_point}>
                                    <input className={styles.unordered__list_point_checkbox_second} type="checkbox" id="point_second" />
                                    <label htmlFor="point_second">78 000 рублей <span className={styles.unordered__list_point_year}>в 2-ой год</span></label>
                                </li>
                                <li className={styles.unordered__list_point}>
                                    <input className={styles.unordered__list_point_checkbox_third} type="checkbox" id="point_third" />
                                    <label htmlFor="point_third">78 000 рублей <span className={styles.unordered__list_point_year}>в 3-ий год</span></label>
                                </li>
                                <li className={styles.unordered__list_point}>
                                    <input className={styles.unordered__list_point_checkbox_fourth} type="checkbox" id="point_fourth" />
                                    <label htmlFor="point_fourth">78 000 рублей <span className={styles.unordered__list_point_year}>в 4-ый год</span></label>
                                </li>
                                <li className={styles.unordered__list_point}>
                                    <input className={styles.unordered__list_point_checkbox_five} type="checkbox" id="point_fifth"/>
                                    <label htmlFor="point_fifth">26 000 рублей <span className={styles.unordered__list_point_year}>в 5-ый год</span></label>
                                </li>
                            </ul>
                        </div>
                    </div>
